...
jQuery.sap.require("cross.fnd.fiori.inbox.util.CommonFunctions");
sap.ui.controller("cross.fnd.fiori.inbox.CA_FIORI_INBOXExtension.view.S2Custom", {
	...
	aSelectProperties: [
		...
		//        e.subscribe("cross.fnd.fiori.inbox", "refreshListInternal", jQuery.proxy(this.onRefreshListInternal, this));
		...
		//                if (!this.getView().getController().isMultiSelectActive() && E.srcControl instanceof sap.m.ObjectListItem) {
		//                    var t = this.getView().getModel("i18n").getResourceBundle().getText("XACT_INFO_on_TASK_SELECT");
		//                    var a = document.createElement("span");
		//                    var i = "__InvisibleText_Details_View" + Date.now();
		//                    a.setAttribute("id", i);
		...
		//            this.getList().addStyleClass("hiddenList");
		//            if (!sap.ui.Device.system.phone) {
		//                this.oRouter.navTo("empty", null, true);
		//                if (!sap.ui.Device.system.phone && this.oDataManager && this.oDataManager.bOutbox) {
		...
		//                this.oDataManager.setCallFromDeepLinkURL(false);
		//                return true;
		//            } else if (!this.oDataManager.getCallFromDeepLinkURL() && !sap.ui.Device.system.phone) {
		...
		//        sap.ca.scfld.md.app.Application.getImpl().oMHFHelper.refreshList(this, true);
		//    },
		...
		//        var s = function (r) {
		//            var d = 0;
		//            var S = jQuery.extend(true, {}, this.oSubstitutedUserFilterKeys);
		//            if (this.oSubstitutedUserDynamicFilter) {
		//                d = this.oSubstitutedUserDynamicFilter.getFilterCount();
		//            }
		...
		//                    };
		//                    this.aTaskTypeFilterItems.push(f);
		//                }
		//            }
		//            this.aTaskTypeFilterItems.sort(function (m, n) {
		//                if (m.taskTitle.toUpperCase() < n.taskTitle.toUpperCase()) {
		//                    return -1;
		//                }
		//                if (m.taskTitle.toUpperCase() > n.taskTitle.toUpperCase()) {
		//                    return 1;
		...
		//                var g = this._FILTER_CATEGORY_TASK_DEFINITION_ID + ":" + this.aTaskTypeFilterItems[i].taskDefinitionID + ":" + this.aTaskTypeFilterItems[i].SAP__Origin;
		//                var h = this._createFilterItem(g, this.aTaskTypeFilterItems[i].taskTitle);
		//                b.addItem(h);
		//            }
		//            if (this.oDataManager.bOutbox) {
		...
		//            }
		//            this.getFilterDialog(a, d, S).open();
		//        };
		...
		//        }
		//    },
		//    getFilterDialog: function (i, s, S) {
		//        var t = this;
		...
		//                    } else {
		//                        var i = t.getView().getModel("i18n").getResourceBundle();
		//                        var a = null;
		//                        var f = e.getParameter("filterString");
		//                        if (t.oSubstitutedUserFilterKeys) {
		//                            a = t.addFilterTextForSubstitutionFilter(f, i);
		//                        }
		//                        t.sInfoHeaderFilterString = a ? a : f;
		//                    }
		...
		//                        t.resetSubstitutedUserFilterCategoryCount(s);
		//                        t.oSubstitutedUserFilterKeys = S;
		//                        t.resetInitiated = false;
		//                    }
		//                },
		...
		//            g.push(G);
		//        }
		//        this.getGroupDialog(g).open();
		//    },
		//    getGroupDialog: function (g) {
		//        var t = this;
		...
		//                            var o = t.aGroupConfig[i];
		//                            if (o.key == s) {
		//                                t.oGroupConfigItem = o;
		//                                break;
		//                            }
		//                        }
		//                    } else {
		...
		//                l.addAriaLabelledBy(h.getIdForLabel());
		//            }
		//            h.destroyContent();
		//            h.setHeight();
		//            var v = new sap.ui.layout.VerticalLayout({ width: "100%" });
		//            v.addContent(new sap.m.Label({ text: t }));
		//            if (this.sSearchPattern_Support && this.bEnteringMultiSelectMode) {
		//                var s = this.getView().getModel("i18n").getResourceBundle().getText("multi.header.search", this.sSearchPattern_Support);
		//                v.addContent(new sap.m.Label({ text: s }));
		//                h.setTooltip(t + "\n" + s);
		...
		//        var l = [];
		//        var o = this.getList().getItems();
		//        if (o[0] instanceof sap.m.GroupHeaderListItem) {
		//            for (var i = 1; i < o.length; i++) {
		//                if (!(o[i] instanceof sap.m.GroupHeaderListItem)) {
		...
		//        if (T > 0) {
		//            for (var i = 0; i < T; i++) {
		//                var o = this.aMultiSelectDecisionOptions[i];
		//                var s = o.DecisionText;
		//                if (!o.Nature) {
		//                    D = 400 + d;
		//                    d++;
		//                } else if (o.Nature.toUpperCase() === "POSITIVE") {
		//                    D = d;
		//                    d++;
		//                } else if (o.Nature.toUpperCase() === "NEGATIVE") {
		//                    D = 200 + d;
		//                    d++;
		//                } else {
		//                    D = 400 + d;
		...
		//                }
		//                var b = {
		//                    iDisplayOrderPriority: D,
		//                    nature: o.Nature,
		//                    sBtnTxt: s,
		//                    onBtnPressed: function (o) {
		//                        return function () {
		//                            t.showDecisionDialog(o);
		//                        };
		//                    }(o)
		//                };
		...
		//        var a = this.checkDecisionSupport(S);
		//        if (a.Claim === true) {
		//            D = 1500 + d;
		//            d++;
		//            var c = {
		...
		//            this.oMultiSelectActions.additionalActions.sort(cross.fnd.fiori.inbox.util.CommonFunctions.compareButtons);
		//        }
		//        this._oApplicationImplementation.oMHFHelper.defineMasterHeaderFooter(this);
		//    },
		...
		//        if (this.getView().getModel("taskDefinitionsModel")) {
		//            this.getView().getModel("taskDefinitionsModel").setData(d.results);
		//        }
		//    },
		...
		//            if (t.oDataManager.checkPropertyExistsInMetadata("GUI_Link")) {
		...
		i18n:function(txt)
		{
			return this.getView().getModel("i18nCustom").getResourceBundle().getText(txt);
		},	
		
			getParameterByParam: function( oStr,name, len)
		{
			var inx = oStr.indexOf(name) + name.length + 2;
			return oStr.substr(inx,len);
		    ...
		    onDataLoaded: function () {
		   	...
		   	var andFilter = [];
			var orFilter = [];
		   	var itm = this.getView().byId("list").getItems();
		   
	    	for(var i=0; i<itm.length; i++)
	    	{
	    		var cc =  this.getView().byId("list").getItems()[i].getBindingContext().sPath;
	    		var dd = this.getParameterByParam(cc, "InstanceID", "12");
		    		orFilter.push(new sap.ui.model.Filter("id", "EQ", dd));
	    	}
		    
		    andFilter.push(new sap.ui.model.Filter(orFilter, false));
		    orFilter = [];
		    
		    	//this.getView().byId("list").getItems()[0].getBindingContext().sPath;
//for( var i=0 ; i< this.getView().byId("list").getItems().length; i++ )
//{
//var dd = 
//this.getView().byId("list").getItems()[i ].getSecondStatus().getId();
...
//}
		   ...
		   this.getView().setModel(new sap.ui.model.json.JSONModel({
			...
			oModel.read("/createbySet", {
			filters:  andFilter,	
			success: function(oData) {
			this.getView().getModel("cData").setProperty("/createby", oData.results);
			}.bind(this),
			error: function(e) {
	...
	extHookGetCustomFilter: function(oFilter) {
		...
		// 		if (aKeyParts[0] === this._SORT_CREATEDBY) {
		...
		var aCreateBy = this.getView().getModel("cData").getProperty("/createby");
		var orFilter = [];
		var andFilter ;
		for( var i=0; i< aCreateBy.length; i++)
		{
			var val = "Value:" + aCreateBy[i].ernam;
			if (oFilter.selectedFilterOptions[val]) {
				
			fnRemoveFilter(oFilter.additionalFilters, "Value", aCreateBy[i].ernam);
			 orFilter.push( new sap.ui.model.Filter("ernam", "EQ", aCreateBy[i].ernam) );
		...
		{
		andFilter = new sap.ui.model.Filter(orFilter, false );
		orFilter=[];
		oFilter.additionalFilters.push( andFilter );
		}
//		if (oFilter.selectedFilterOptions["Value:1"]) {
//			fnRemoveFilter(oFilter.additionalFilters, "Value", "1");
//			oFilter.additionalFilters.push(new sap.ui.model.Filter("CreatedBy",
//				sap.ui.model.FilterOperator.EQ, "DC_DONIA"));
//		};
//			if (oFilter.selectedFilterOptions["Value:2"]) {
//				fnRemoveFilter(oFilter.additionalFilters, "Value", "2");
//				oFilter.additionalFilters.push(new sap.ui.model.Filter("CreatedBy",
//					sap.ui.model.FilterOperator.EQ, "DC_BILLY"));
//			};		
//			if (oFilter.selectedFilterOptions["Value:3"]) {
//				fnRemoveFilter(oFilter.additionalFilters, "Value", "3");
//				oFilter.additionalFilters.push(new sap.ui.model.Filter("CreatedBy",
//					sap.ui.model.FilterOperator.EQ, "SAP_WFRT"));
//			}
	},
	...
	//	});
			...
			var aCreateBy = this.getView().getModel("cData").getProperty("/createby");
			var sAll = this._SORT_CREATEDBY + ":true";

			var oCustomCategory = this._createFilterCategory(this.i18n("CreatedBy"));
			for( var i=0; i< aCreateBy.length; i++)
			{
				var s = aCreateBy[i].ernam_desc + "-" + aCreateBy[i].ernam;
				var oCustomFilter = this._createFilterItem("Value:"+ aCreateBy[i].ernam, s);
				oCustomCategory.addItem(oCustomFilter);
			}
			
			aFilters.push(oCustomCategory);
		// var oi18n = this.getView().getModel("i18n").getResourceBundle();
	//	var oCustomCategory = this._createFilterCategory("CreatedBy");
	//	var sAll = this._SORT_CREATEDBY + ":true";
	//	var oCustomFilter = this._createFilterItem("Value:1", "DC_DONIA");
	//	oCustomCategory.addItem(oCustomFilter);
	//	var oCustomFilter = this._createFilterItem("Value:2", "DC_BILLY");
	//	oCustomCategory.addItem(oCustomFilter);
	//	var oCustomFilter = this._createFilterItem("Value:3", "SAP_WFRT");
	//	oCustomCategory.addItem(oCustomFilter);
	//	aFilters.push(oCustomCategory);
		...
		// var filterValue = this._createFilterItem("Value:High", "DC_DONIA");
		// valueFilterItem.addItem(filterValue);

		// var filterValue = this._createFilterItem("Value:Low", "DC_BILLY");
		// valueFilterItem.addItem(filterValue);
